...
final class InitialViewController: UIViewController {
    ...
    private func setSubviewLayouts() {
        logo.edgeAnchors(top: view.safeAreaLayoutGuide.topAnchor,
                         padding: UIEdgeInsets(top: 48, left: 0, bottom: 0, right: 0))
        logo.centerAnchors(centerX: view.centerXAnchor)
        logo.dimensionAnchors(height: 60, width: 60)

        loginButton.edgeAnchors(top: logo.bottomAnchor,
                                padding: UIEdgeInsets(top: 48, left: 0, bottom: 0, right: 0))
